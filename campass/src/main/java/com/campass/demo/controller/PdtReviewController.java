...
public class PdtReviewController {
	...
	@PostMapping(value="/product/review/save", produces=MediaType.APPLICATION_JSON_VALUE)
	...
	@DeleteMapping(value="/product/review/delete", produces=MediaType.APPLICATION_JSON_VALUE)
